...
const Hero = () => {
  return (
    <div className='relative w-full h-[120vh]  sm:h-[100] '>
    
      {/* OVERLAY */}
      <div className='absolute top-0 left-0 h-full w-full bg-gray-800 opacity-90'>
       ...
       {/* VIDEO */}
        ...
        {/* TEXT-CONTAINER */}
        <div className='absolute z-[100] w-full h-full left-[50%] top-[40%] translate-x-[-50%] translate-y-[-50%]'>
            <div className='flex items-center justify-center w-full h-full flex-col'>
                ...
                <div data-aos="fade-up">
                    ...
                    <p className='md:text-base text-center text-lg text-white font-normal [word-spacing:5px]'>
                        Get the best prices on 2000,0000+ properties,worldwide </p>
                       </div>
                     <Searchbox/>
                     ...
                     hover:ring-red-400 transition-all ease-out duration-300'>
                      ...
                      bg-white opacity-10 rotate-12 group-hover:-transition-x-40 ease'></span>
